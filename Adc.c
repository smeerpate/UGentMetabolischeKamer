...
//--- SOC0 configuration
	AdcaRegs.ADCSOC0CTL.bit.TRIGSEL = 0x07;		// Trigger
	AdcaRegs.ADCSOC0CTL.bit.CHSEL = 0;			// Convert channel
	AdcaRegs.ADCSOC0CTL.bit.ACQPS = 19;			// Acquisition window: 19+1 samples
...
//--- ADCA1 interrupt configuration
	AdcaRegs.ADCINTSEL1N2.bit.INT1CONT = 1;		// Interrupt pulses continuously, don't matter flag states
