...
#define PWM_200kHz          1000
#define PWM_200kHz_DUTY     400


#define SEVENSEG_CLK_GPIO1          GPIO4
#define SEVENSEG_DIO_GPIO1          GPIO3
#define SEVENSEG_CLK_GPIO2          GPIO6
#define SEVENSEG_DIO_GPIO2          GPIO5

#define PLANT_REFRIGITATECTRLPIN    GPIO32
#define PLANT_HEATCTRLPIN           GPIO22

#define LED_RED                     GPIO34
#define LED_BLUE                    GPIO31

#define LED_ACTIVE                  GPIO130
#define LED_HEAT                    GPIO63
#define LED_COOL                    GPIO64
